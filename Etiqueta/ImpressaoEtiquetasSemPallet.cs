...
namespace Etiqueta
{
    internal class ImpressaoEtiquetasSemPallet
    {
        ...
        static Banco reabanco = Dados.retornaBanco();
        ...
        {
            reabanco = Dados.retornaBanco();
            Dados.deletaTudoBancoDestrinche();
            ...
            while (reader.Read())
            {
                ...
                for (var i = 0; i < valorTotal; i++)
                {
                    ...
                    Dados.insereEmBancoASerImpresso(destrinche);
                }
        ...
        static void imprimeTudoNoBancoDeDadosEDelete(String impressora, String separador)
        {
            ...
            int numeracaoTotalEtiqueta = Dados.retornaNumeroTotalImpressora();
